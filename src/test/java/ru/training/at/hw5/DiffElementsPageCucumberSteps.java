...
public class DiffElementsPageCucumberSteps extends ParentPageForCucumberSteps {
//    public DiffElementsPageCucumberSteps(WebDriver driver, Properties properties, List<String> expectedTextFromLinksInHeader, List<String> expectedTextFromLeftMenuItems, String login, String password) {
